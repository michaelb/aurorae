...
set background=dark
"hi clear "<- do we really want to clear previous highlights?
if exists('syntax_on')
  syntax reset
endif
let g:colors_name='aurora'

hi Normal guifg=#e5e9f0 ctermfg=255 guibg=#232627 ctermbg=235 gui=NONE cterm=NONE
...
hi SignColumn guifg=NONE ctermfg=NONE guibg=#232627 ctermbg=235 gui=NONE cterm=NONE
...
hi TabLineFill guifg=NONE ctermfg=NONE guibg=#232627 ctermbg=235 gui=NONE cterm=NONE
...
hi DiagnosticWarning guifg=#d08770 ctermfg=173 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi DiagnosticInformation guifg=#ebcb8b ctermfg=222 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi DiagnosticHint guifg=#ebcb8b ctermfg=222 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsDefaultError guifg=#f44747 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsDefaultWarning guifg=#d08770 ctermfg=173 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsDefaultInformation guifg=#ebcb8b ctermfg=222 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspDiagnosticsDefaultHint guifg=#fceb8a ctermfg=228 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspReferenceText guifg=#b48e4a ctermfg=137 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspReferenceRead guifg=#b48e4a ctermfg=137 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspReferenceWrite guifg=#b48e4a ctermfg=137 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspSagaFinderSelection guifg=#b48ead ctermfg=139 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspSagaFloatWinBorder guifg=#b5cea8 ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspSagaRenameBorder guifg=#b5cea8 ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspSagaHoverBorder guifg=#b5cea8 ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspSagaSignatureHelpBorder guifg=#b5cea8 ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspSagaCodeActionBorder guifg=#b5cea8 ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspSagaDefPreviewBorder guifg=#b5cea8 ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi LspLinesDiagBorder guifg=#b5cea8 ctermfg=151 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
